...
function Delta({
  ...
  /** Set to false for metrics where a decrease is favorable (e.g. response time). */
  higherIsBetter?: boolean;
}) {
  const favorable = higherIsBetter ? value > 0 : value < 0;
  const unfavorable = higherIsBetter ? value < 0 : value > 0;
  return (
      ...
      {variant === 'badge' ? (
        <Badge
          className={cn(
            ...
            unfavorable && 'bg-red-500/10 text-red-600 dark:text-red-400',
            className
          )}
          data-slot="delta"
          variant="secondary"
        ...
        <div
          className={cn(
            ...
            unfavorable && 'text-rose-600 dark:text-rose-400',
            className
          )}
          data-slot="delta"
          {...props}
